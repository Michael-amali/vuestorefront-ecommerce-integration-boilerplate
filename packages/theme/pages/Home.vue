        ...
        <SfCarousel class="carousel" :settings="{ peek: 16, breakpoints: { 1023: { peek: 0, perView: 2 } } }">
          ...
          <SfCarouselItem class="carousel__item" v-for="(product, i) in products" :key="i">
            <SfProductCard
              ...
              :regular-price="$n(productGetters.getPrice(product).regular, 'curreny')"
...
import { useProduct, productGetters } from '@vue-storefront/myshop';
...
export default {
  ...
  setup() {
    ...
    const toggleWishlist = (index) => {
      featuredProducts.value[index].isInWishlist = !featuredProducts.value[index].isInWishlist;
    };
    console.log(featuredProducts.value, 'gotten featured');
